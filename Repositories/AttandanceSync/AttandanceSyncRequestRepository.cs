...
{
    /// <summary>
    /// Repository for AttandanceSyncRequest entity operations.
    ...
    public class AttandanceSyncRequestRepository : Repository<AttandanceSyncRequest>, IAttandanceSyncRequestRepository
    {
        ...
        /// </summary>
        /// <returns>Collection of all requests with user, employee, company, tool, and configuration data.</returns>
